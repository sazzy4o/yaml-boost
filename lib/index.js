...
const loadRecursive = (dir, relDir, data, vars) => {
  ...
  if (typeof result === 'string' || result instanceof String) {
    ...
    result = result.replace(/\${opt:([a-zA-Z0-9]+?)(?:, ["']([a-zA-Z0-9\-.]+?)["'])?}/g, (match, k, v) => get(vars, k, v || match)); // load requires 1
